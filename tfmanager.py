...
def read(args):
    # get the file name/path you want to read
...
def show(args):
    # get path to directory you want to show the contents of 
...
def delete(args):
    # get the file name/path you want to delete
...
def rename(args):
    ...
    # validate the type of the new file name
...
def main():
    ...
    parser = argparse.ArgumentParser(description = "This is my really cool text file manager!")
    ...
    parser.add_argument("-s", "--show", type = str, nargs = 1,
                        ...
                        help= "Shows all the text files on the specified directory path.\
